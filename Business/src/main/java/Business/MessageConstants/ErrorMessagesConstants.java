...
public class ErrorMessagesConstants {
    ...
    public static String ERROR_MOVEMENT_RECALCULATING_SADDERS = "There was a problem Recalculating %s Sadders. SadderList Size %d . Expected Sadder: %f Founded Sadder: %f";;
    public static String ERROR_MOVEMENT_SHOULD_BE_ACCOUNT_CURRENCY = "Both Accounts have %s Currency. Movement must be in this currency";
    public static String ERROR_MOVEMENT_SHOULD_USE_ONE_ACCOUNT_CURRENCY = "Movement Currency must be in one of the Accounts Currency. (%s or %s)";
